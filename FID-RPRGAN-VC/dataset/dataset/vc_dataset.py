...
class VCDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        np.sort(train_data_A_idx)
        np.sort(train_data_B_idx)
        ...
        train_data_A = torch.from_numpy(np.array(train_data_A))
        train_data_B = torch.from_numpy(np.array(train_data_B))
        train_mask_A = torch.from_numpy(np.array(train_mask_A))
        train_mask_B = torch.from_numpy(np.array(train_mask_B))
